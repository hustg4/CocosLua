...
#ifndef __The9Framework__FileManager__
#define __The9Framework__FileManager__
...
public:
    ...
    //保存数据加文件
    static bool writeDataToFile(const unsigned char *content, unsigned long len, const std::string &filePath, bool isAppend = false);
...
#endif /* defined(__The9Framework__FileManager__) */
