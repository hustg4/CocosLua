...
function clsDemoViewController:showView()
    ...
    tableView:registerScriptHandler(cl.makeScriptHandler(self,self.numberOfCellsInTableView),cc.NUMBER_OF_CELLS_IN_TABLEVIEW)  
    tableView:registerScriptHandler(cl.makeScriptHandler(self,self.scrollViewDidScroll),cc.SCROLLVIEW_SCRIPT_SCROLL)
    tableView:registerScriptHandler(cl.makeScriptHandler(self,self.scrollViewDidZoom),cc.SCROLLVIEW_SCRIPT_ZOOM)
    tableView:registerScriptHandler(cl.makeScriptHandler(self,self.tableCellTouched),cc.TABLECELL_TOUCHED)
    tableView:registerScriptHandler(cl.makeScriptHandler(self,self.cellSizeForTable),cc.TABLECELL_SIZE_FOR_INDEX)
    tableView:registerScriptHandler(cl.makeScriptHandler(self,self.tableCellAtIndex),cc.TABLECELL_SIZE_AT_INDEX)
    ...
    scrollView:registerScriptHandler(cl.makeScriptHandler(self,self.scrollViewDidScroll),cc.SCROLLVIEW_SCRIPT_SCROLL)
    scrollView:registerScriptHandler(cl.makeScriptHandler(self,self.scrollViewDidZoom),cc.SCROLLVIEW_SCRIPT_ZOOM)
