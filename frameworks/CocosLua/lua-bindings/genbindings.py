...
def main():
    ...
    try:
        ...
        tolua_root = '%s/framework/lua-bindings' % project_root
        output_dir = '%s/framework/lua-bindings' % project_root
                      
        print 'tolua_root:'+tolua_root
        print 'output_dir:'+output_dir

        cmd_args = {
                    'framework.ini' : ('framework', 'lua_framework_auto'), \
                    }
        target = 'lua'
